  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-background">
      <div className="fixed inset-0 ltr:-scale-x-100">
        <Image
          src="/images/home-background-light.png"
          alt=""
          fill
          priority
          sizes="100vw"
          className="object-cover [[data-theme=dark]_&]:hidden"
        />
        <Image
          src="/images/home-background-dark.png"
          alt=""
          fill
          priority
          sizes="100vw"
          className="hidden object-cover [[data-theme=dark]_&]:block"
        />
